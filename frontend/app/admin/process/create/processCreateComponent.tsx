...
export default function Home({ accessToken }: Props) {
  ...
  const sendProcess = async (e: any) => {
    e.preventDefault();
    const p_name = e.target.process_name.value;
    const p_tasks = tasks;
    fetch(`${api}/admin/project/template/create`, {
      body: JSON.stringify({
        name: p_name,
        process: p_tasks,
  ...
  return (
    <>
      ...
      >
        <div className="bg-[#0a0a0a] rounded-lg p-8 absolute w-4/5 z-50">
          ...
          {editing > 0 ? (
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <select
                    ...
                    onChange={(e) => setEditingT_milestone_tag(e.target.value)}
                  >
                  ...
                  <input
                    ...
                    hidden={editingT_milestone_tag_input || !editingT_milestone}
                    className="w-96"
                    onChange={(e) =>
            ...
            <form className="grid md:grid-cols-2 gap-10" onSubmit={taskCreate}>
              <div className="flex flex-col gap-6">
                <input
                  type="text"
                  name="task_name"
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <select
                    ...
                    onChange={(e) => setCreatingT_milestone_tag(e.target.value)}
                  >
                    <option value="none">Milestone Tag</option>
                    {milestoneTags.map((tag, i) => {
                      if (tag === "") {
      ...
      <form className="flex flex-col gap-6 items-center" onSubmit={sendProcess}>
        <input
          type="text"
          name="process_name"
          required
